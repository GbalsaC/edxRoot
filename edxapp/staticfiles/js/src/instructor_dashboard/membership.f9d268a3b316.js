...
(function() {
  ...
  MemberListWidget = (function() {
    function MemberListWidget($container, params) {
      ...
      this.$('input[type="button"].add').click((function(_this) {
        return function() {
  ...
  AuthListWidget = (function(_super) {
    ...
    AuthListWidget.prototype.add_handler = function(input) {
      if ((input != null) && input !== '') {
        return this.modify_member_access(input, 'allow', (function(_this) {
    ...
    AuthListWidget.prototype.reload_list = function() {
      return this.get_member_list((function(_this) {
        return function(error, member_list) {
          if (error !== null) {
            return _this.show_errors(error);
          }
          _this.clear_rows();
      ...
      return $.ajax({
        ...
        error: std_ajax_err((function(_this) {
          return function() {
            ...
            return typeof cb === "function" ? cb(gettext("Error fetching list for role") + (" '" + _this.rolename + "'")) : void 0;
          };
        })(this))
      });
    };
  ...
  this.AutoEnrollmentViaCsv = (function() {
    function AutoEnrollmentViaCsv($container) {
      ...
      this.$browse_button.on("change", (function(_this) {
      ...
      this.$enrollment_signup_button.click((function(_this) {
        return function() {
    ...
    AutoEnrollmentViaCsv.prototype.display_response = function(data_from_server) {
      ...
      render_response = (function(_this) {
        return function(title, message, type, student_results) {
  ...
  BetaTesterBulkAddition = (function() {
    function BetaTesterBulkAddition($container) {
      ...
      this.$btn_beta_testers.click((function(_this) {
        return function(event) {
    ...
    BetaTesterBulkAddition.prototype.display_response = function(data_from_server) {
      ...
      render_list = (function(_this) {
        return function(label, ids) {
  ...
  BatchEnrollment = (function() {
    function BatchEnrollment($container) {
      ...
      this.$task_response = this.$container.find(".request-response");
      this.$request_response_error = this.$container.find(".request-response-error");
      this.$enrollment_button.click((function(_this) {
        return function(event) {
          var send_data;
  ...
  AuthList = (function() {
    function AuthList($container, rolename) {
      ...
      this.$allow_button.click((function(_this) {
        return function() {
  ...
  Membership = (function() {
    function Membership($section) {
      ...
      this.auth_lists = _.map(this.$auth_list_containers, (function(_this) {
        return function(auth_list_container) {
          var rolename;
      ...
      this.$list_selector.change((function(_this) {
        return function() {
