...
(function() {
  ...
  ECommerce = (function() {
    ...
    function ECommerce($section) {
      ...
      this.$list_sale_csv_btn.click((function(_this) {
        return function(e) {
          var url;
      ...
      this.$list_order_sale_csv_btn.click((function(_this) {
        return function(e) {
          var url;
      ...
      this.$download_coupon_codes.click((function(_this) {
        return function(e) {
          var url;
      ...
      this.$download_registration_codes_form.submit((function(_this) {
        return function(e) {
          _this.$error_msg.attr('style', 'display: none');
          return true;
        };
      })(this));
      this.$active_registration_codes_form.submit((function(_this) {
        return function(e) {
          _this.$error_msg.attr('style', 'display: none');
          return true;
        };
      })(this));
      this.$spent_registration_codes_form.submit((function(_this) {
        return function(e) {
          _this.$error_msg.attr('style', 'display: none');
          return true;
        };
