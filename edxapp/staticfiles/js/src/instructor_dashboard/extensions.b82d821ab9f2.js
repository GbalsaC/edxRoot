...
(function() {
  ...
  Extensions = (function() {
    function Extensions($section) {
      ...
      this.$change_due_date.click((function(_this) {
        return function() {
          var send_data;
          _this.clear_display();
      ...
      this.$reset_due_date.click((function(_this) {
        return function() {
          var send_data;
          _this.clear_display();
      ...
      this.$show_unit_extensions.click((function(_this) {
        return function() {
          var send_data, url;
          _this.clear_display();
      ...
      this.$show_student_extensions.click((function(_this) {
        return function() {
          var send_data, url;
          _this.clear_display();
          _this.$grid_table.text('Loading');
